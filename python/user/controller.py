...
def allCredits():
    ...
    for u in users:
        ...
        if c.name is not None:
            userJson['name'] = str(u.name)
        else:
            userJson['name'] = ''
        userJson['money'] = str(u.money)
        userJson['email'] = str(u.email)
